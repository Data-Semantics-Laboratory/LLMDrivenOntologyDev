...
tsv_dir = '/Users/andreachristou/Documents/git/LLMDrivenOntologyDev/WikipediaData/MakingTSVs/Enslaved/EnslavedTSV'
txt_dir = '/Users/andreachristou/Documents/git/LLMDrivenOntologyDev/Results/triples_GPT-4_Enslaved'
...
for tsv_file, txt_file in file_matches.items():
    ...
    try:
        ...
        output_file = f'similarity_results_Enslaved{os.path.splitext(tsv_file)[0]}.csv'
